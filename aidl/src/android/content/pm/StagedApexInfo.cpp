...
namespace content {
namespace pm {
::android::status_t StagedApexInfo::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readUtf8FromUtf16(&diskImagePath);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
  ...
  _aidl_ret_status = _aidl_parcel->readBool(&hasClassPathJars);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_parcel->setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
...
::android::status_t StagedApexInfo::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  size_t _aidl_start_pos = _aidl_parcel->dataPosition();
  ...
  _aidl_ret_status = _aidl_parcel->writeUtf8AsUtf16(diskImagePath);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  ...
  _aidl_ret_status = _aidl_parcel->writeBool(hasClassPathJars);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
